...
export default function MenteeDashboard() {
    ...
    return(
        ...
        <section className="py-6 px-4 lg:px-20">
            ...
            <div className="md:flex md:justify-center md:gap-6">
                <div className="my-2 bg-gray-50 border rounded p-4 md:w-1/3">
                    ...
                    <h4 className="font-semibold">Approx. 30 minutes | <span className="text-indigo-600">$0</span></h4>
                </div>
                ...
                <div className="my-2 bg-gray-50 border rounded p-4 md:w-1/3">
                    ...
                    <h4 className="font-semibold">Approx. 45 minutes | <span className="text-indigo-600">$39</span></h4>
                </div>
                ...
                <div className="my-2 bg-gray-50 border rounded p-4 md:w-1/3">
                    ...
                    <h4 className="font-semibold">Approx. 60 minutes | <span className="text-indigo-600">$89</span></h4>
                </div>
            </div>
        </section>
        ...
        <div className="md:flex md:justify-center md:gap-10">
            ...
            <div className="my-4">
                <h4 className="font-semibold lg:text-xl bg-indigo-50">How can i get in touch with a mentor?</h4>
            ...
            <div className="my-4">
                <h4 className="font-semibold lg:text-xl bg-indigo-50">How much do mentors cost? How does pricing work?</h4>
            ...
            <div className="md:w-1/2">
            <div className="my-4">
                <h4 className="font-semibold lg:text-xl bg-indigo-50">What can I expect from mentors?</h4>
